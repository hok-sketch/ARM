...
const dict = {
  hy: {
    ...
    aboutH: 'Մեր տվյալամշակման կենտրոնը Երևանում',
    aboutP: 'SaveAndStore-ը հայկական ընկերություն է՝ սեփական հզորություններով Երևանում։ Մենք ապահովում ենք ցածր ուշացում երկրի ներսում, տեղական հաշիվներ և օպերատիվ ինժեներական արձագանք։',
    aboutList: [
      'Սեփական ռեքեր և գծեր տվյալակենտրոնում Երևան քաղաքում',
      'N+1 էլեկտրամատակարարում և գեներատորային պահուստ',
      'DDoS պաշտպանության պրոֆիլներ ըստ բիզնեսի',
      '24/7 օն-քոլ ինժեներական աջակցություն հայերեն/ռուսերեն/անգլերեն',
      'Իրավաբանական և հաշվապահական հաշվարկներ ՀՀ-ում (AMD, բանկային փոխանցումներ)'
    ]
  },
  ru: {
    ...
    ,
    localStrip: 'Локальная компания в Ереване: собственные мощности и поддержка 24/7',
    aboutH: 'Наш дата-центр в Ереване',
    aboutP: 'SaveAndStore — армянская компания со своими мощностями в Ереване. Мы обеспечиваем низкую задержку по стране, местные счета и оперативный инженерный ответ.',
    aboutList: [
      'Собственные стойки и магистрали в ДЦ г. Ереван',
      'Электропитание N+1 и резервные генераторы',
      'Профили защиты от DDoS под задачи бизнеса',
      'Круглосуточная on‑call поддержка (hy/ru/en)',
      'Юрлица и расчёты в РА (AMD, безнал)'
    ]
  },
  en: {
    ...
    ,
    localStrip: 'Local company in Yerevan: own infrastructure and 24/7 support',
    aboutH: 'Our Yerevan Data Center',
    aboutP: 'SaveAndStore is an Armenian company with its own capacity in Yerevan. We provide low in‑country latency, local invoicing, and rapid engineer response.',
    aboutList: [
      'Own racks and uplinks in a Yerevan DC',
      'N+1 power and generator backup',
      'Business‑tuned DDoS protection profiles',
      '24/7 on‑call support (hy/ru/en)',
      'Local entity & invoicing in AMD'
    ]
  }
}
              ...
              <ul className='mt-4 space-y-2 text-sm hyp'>
                {t.aboutList.map((item, i) => (
                  <li key={i} className='flex items-start gap-2'>
                    <Check className='w-4 h-4 mt-0.5' /> {item}
                  </li>
                ))}
              </ul>
            </div>
            <div>
              <div className='rounded-3xl shadow-sm border bg-white p-5 text-sm text-slate-700'>
                <div className='flex items-center justify-between py-1'>
                  <span>Latency in Armenia</span><span>&lt; 5 ms</span>
                </div>
                <div className='flex items-center justify-between py-1'>
                  <span>Power redundancy</span><span>N+1</span>
                </div>
                <div className='flex items-center justify-between py-1'>
                  <span>Support</span><span>24/7 on‑call</span>
                </div>
                <div className='flex items-center justify-between py-1'>
                  <span>Invoicing</span><span>AMD</span>
                </div>
              </div>
            </div>
          </div>
